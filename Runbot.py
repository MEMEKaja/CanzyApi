...
bot = telebot.TeleBot(os.getenv("7689507406:AAGLVNMaS__S_w-vQNHoeitihlyqAk8kyfM"), parse_mode=None)

# Replace `os.getenv("GENAI_API_KEY")` with your own API key
genai.configure(api_key=os.getenv("AIzaSyCORFugHoKwgwFbd1MfMXZb0Ca2He4HJjM"))
